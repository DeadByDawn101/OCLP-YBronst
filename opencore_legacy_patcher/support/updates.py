...
REPO_LATEST_RELEASE_URL: str = "https://api.github.com/repos/DeadByDawn101/OCLP-YBronst/releases/latest"
        ...
        for asset in data_set["assets"]:
            ...
            if asset["name"] == "OpenCore-Patcher.pkg":
                self.latest_details = {
                    ...
                    "Github Link": f"https://github.com/DeadByDawn101/OCLP-YBronst/releases/{latest_remote_version}",
                }
                return self.latest_details
